...
#    cb.set_ticks(np.round(np.linspace(vmin,vmax,10),1)) 
    ...
    plt.text(-107.5,-66.5,title,fontsize=14)
    plt.text(-90,-66.5,support_pie.getChar(i),fontsize=14)
...
value_min,value_max = [0,0,0,0,0,0,0],[50,50,50,50,50,50,50]
...
ax.set_xticks(())
ax.set_yticks(())
plt.savefig('D:/Refresh/data/CHINARE-35/pic/藻种水柱积分相对丰度平面分布-english.png'
