...
nutrition_min,nutrition_max = [-1.7,32.7,0,0.6,15],\
                                [1.7,34.5,34,2.5,70]
nutrition =['Temperature [℃]', 'Salinity [psu]','NO3 [μmol/L]','PO4 [μmol/L]','SiO3 [μmol/L]']
nutrition_name = ['T','S','Nitrate','Phosphate','Silicate']
nutrition_danwei = ['℃','PSU','μmol·$\mathregular{L^{-1}}$','μmol·$\mathregular{L^{-1}}$',
                    'μmol·$\mathregular{L^{-1}}$']
#营养盐比值
nutrition_min,nutrition_max = [0,11,0],\
                                [20,100,1.2]
nutrition =['N/P', 'Si/P','N/Si']
nutrition_name = ['N/P','Si/P','N/Si']
nutrition_danwei = ['','','']
...
#            plt.subplot(index+1,column,num)
        ...
        #AS
        plt.text(lon_left+0.5,-67,s)
        plt.text(lon_right-3,-67,xuhao)         
        #画底图
...
plt.savefig('D:/Refresh/data/CHINARE-362/pic/NPSI比值分布-english.png',
