...
#读取数据
df = pd.read_excel('D:/Refresh/data/CHINARE-362/水柱积分藻种数据.xlsx',
...
fig_dir = 'D:/Refresh/data/CHINARE-362/pic/特征色素积分分布-english.png' #图片保存路径
...
for i in range(index):
    for j in range(column):
        ...
        plot(z[num],df,image)
        plt.text(-110,-66,support_pie.getChar(num),fontdict=fontsize)
        plt.text(-123.7,-66.5,s=text[num],fontdict=fontsize)
