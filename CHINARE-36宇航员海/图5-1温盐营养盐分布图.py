...
nutrition_min,nutrition_max = [-1.8,33.3,14,0.8,20],\
                                [1.9,34.7,30,2.5,70]
...
#            plt.subplot(index+1,column,num)
        ...
        #AS
        plt.text(lon_left+0.5,-62,s)
        plt.text(lon_right-8,-62,xuhao)         
        #画底图
...
plt.savefig('D:/Refresh/data/CHINARE-36/pic/TSNPSi分布-english.png',
